    ...
    players: [
      {
        ...
        hand: [
          ...
          { id: 'card-hand-2', name: '圣光护卫', terms: [initialTerms[1]], finalCost: 3, type: '造物牌', description: '获得4点生命值。', health: 4, attack: 0, artId: 'card-art-4' },
          { id: 'card-hand-3', name: '召唤元素', terms: [initialTerms[4]], finalCost: 3, type: '造物牌', description: '回合结束时，创造1个1/1的法力造物。', health: 2, attack: 2, artId: 'card-art-3' },
          { id: 'card-hand-4', name: '影子刺客', terms: [initialTerms[0]], finalCost: 4, type: '造物牌', description: '获得2点攻击力。', health: 2, attack: 3, artId: 'card-art-5' },
