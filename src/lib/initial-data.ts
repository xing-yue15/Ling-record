...
export const initialTerms: Term[] = [
  ...
  // --- 原初术式 (Primal Art) ---
  {
    ...
    cost: '/5',
    description: {
      spell: '若此牌是本回合所有已打出牌中消耗最高的，则触发？？',
      creature: '若此牌是本回合所有已打出牌中消耗最高的，则触发？？',
    },
    artId: 'card-art-1',
  },
  {
  ...
  },
  {
    ...
    name: '全能X',
    type: '特殊',
    cost: 1000, // Assuming X=1
    description: {
      spell: '选择一张已知卡牌，增加或减少其X 个基础/特殊词条。',
      creature: ' ',
    },
    artId: 'card-art-5',
  },
  ...
  // --- 混乱术式 (Chaos Art) ---
  {
    ...
    cost: '/2',
    description: {
      spell: '打出时，若拥有者手牌数量大于或等于7张，则触发？？',
      creature: '打出时，若拥有者手牌数量大于或等于7张，则触发？？',
    },
    artId: 'card-art-6',
  },
  {
  ...
  },
  {
    ...
    name: '代换X',
    type: '特殊',
    cost: 50, // Assuming X=1
    description: {
      spell: '选择你手中的X张牌，向你的对手发起一次交换提议...',
  ...
  // --- 爱恋术式 (Love Art) ---
  {
    ...
    cost: '/4',
    description: {
      spell: '若对方本回合打出的是法术牌触发？？',
      creature: '若对方本回合打出的是造物牌触发？？',
    },
    artId: 'card-art-4',
  },
  {
  ...
  },
  {
    ...
    name: '同心X',
    type: '特殊',
    cost: 20, // Assuming X=1
    description: {
      spell: '选择2个目标，使其在X回合内共享（数值÷2x，平均分给每个目标）受到的所有效果。',
  ...
  // --- 幸福术式 (Happiness Art) ---
  {
    ...
    cost: '/3',
    description: {
      spell: '若你在上个回合没有受到任何伤害，则触发？？',
      creature: '若自身上个回合没有受到任何伤害，回合开始时触发？？',
    },
    artId: 'card-art-4',
  },
  {
  ...
  // --- 痛苦术式 (Pain Art) ---
  {
    ...
    cost: '/2',
    description: {
      spell: '若你在上个回合受到任何伤害，则触发？？',
      creature: '若自身上个回合受到任何伤害，回合开始时触发？？',
    },
    artId: 'card-art-1',
  },
  {
  ...
  // --- 无畏术式 (Fearless Art) ---
  {
    ...
    cost: '/2',
    description: {
      spell: '生命值低于其上限的30%时触发？？',
      creature: '自身生命值低于其上限的30%时触发？？',
    },
    artId: 'card-art-6',
  },
  {
  ...
  },
  {
    ...
    cost: 6, // Assuming X=1
    description: {
      spell: '给予一个造物目标传承 2X( 传承 X: 造物获得+X/+X，其死亡后将该增益给予其他随机存活的友方造物；若没有其他造物，则为施法者恢复X点生命值)。',
  ...
  // --- 懦弱术式 (Cowardice Art) ---
  {
    ...
    cost: '*2',
    description: {
      spell: '当敌方打出法术牌时触发？？并选择是否打出（每回合限一次）。',
      creature: '当敌方打出造物时触发？？并选择是否打出（每回合限一次）。',
    },
    artId: 'card-art-5',
  },
  {
  ...
  },
  {
    ...
    description: {
      spell: '敌方下一次出牌消耗-40x。',
      creature: '攻击敌方玩家后 使其下一次出牌消耗-20X。',
    },
    artId: 'card-art-6',
  },
  {
...
artId: 'card-art-4',
  ...
  },
  {
    ...
    description: {
      ...
      creature: 'X 回合内，获得除自身外所有单位失去生命值的总和。',
    },
    artId: 'card-art-4',
  },
  {
    ...
    cost: 15, // Assuming X=1
    description: {
      spell: '选择一个目标，赋予 X层逆命（死亡时移除所有逆命层数，并以等同于移除层数的生命值复活）。',
      creature: '自身获得X层逆命。',
    },
    artId: 'card-art-3',
  },
